...
public class Main extends JFrame {
	...
	public Main() {
		...
		lblSatIsUpdating.setBounds(10, 11, 667, 24);
		...
		lblPleaseWaitA.setBounds(10, 37, 667, 14);
		contentPane.add(lblPleaseWaitA);
		
		JPanel panel = new JPanel();
		panel.setBounds(10, 76, 667, 24);
		...
		lblNewLabel_0.setPreferredSize(new Dimension(110, 20));
		...
		lblNewLabel_1.setPreferredSize(new Dimension(110, 20));
		...
		lblNewLabel_2.setPreferredSize(new Dimension(110, 20));
		...
		lblNewLabel_3.setPreferredSize(new Dimension(110, 20));
		...
		lblNewLabel_4.setPreferredSize(new Dimension(110, 20));

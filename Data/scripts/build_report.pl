#!/usr/bin/perl
# Usage:
#   build-report.pl [-no_files] <Output file prefix> <Path to scripts>
#
# Where:
#   -no_files - Create only the output report.
#   -data_stability - Only run data stability parsing.
#   <Output file prefix> - Add this prefix to the output report.
#   <Path to scripts> - Directory where the scripts are stored.
#
